...
const handleContactForm = () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Create mailto link
        const mailtoLink = `mailto:awaisaslam668@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
    ...
    preloader.innerHTML = `
        <div class="preloader-content">
            <div class="loader">
                ...
                <div class="loader-ring"></div>
                <div class="loader-ring"></div>
                <div class="loader-text">Awais Aslam</div>
            </div>
        </div>
    `;
